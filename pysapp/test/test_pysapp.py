...
All numerical results are validated against the COESA standard:
    http://hdl.handle.net/2060/19770009539
Functions to validate atm function taken from aeropy (c) 2015 project:
    https://github.com/AeroPython/aeropy
which it's based on scikit-aero (c) 2012 scikit-aero authors:
'''
